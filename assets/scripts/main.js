...
function initFormHandler() {
	...
	form.addEventListener('submit', (event) => {
		...
		// B5. Build a plain object from the FormData entries
		const recipeObject = {};
		...
		// B7. Set the card's data to the recipeObject
		...
		// B9. Get existing recipes, add the new one, and save back to localStorage
